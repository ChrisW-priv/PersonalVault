...
### C++
#TODO Make this code better, currently copied from [here](https://www.programiz.com/dsa/doubly-linked-list), but this can be a class that would encapsulate this.
```C++
#include <iostream>
using namespace std;
