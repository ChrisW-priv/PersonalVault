We often have algorithms that look for the shortest/longest paths on the [[Graph]], but often the implementations return just "length" not the path to end node.
